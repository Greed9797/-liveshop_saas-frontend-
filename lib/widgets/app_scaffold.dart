    ...
    final items = <Widget>[
      ...
      if (isClienteParceiro) ...[
        ...
        _MenuItem(
          ...
          label: 'Agenda',
          route: AppRoutes.clienteAgenda,
          isSelected: currentRoute == AppRoutes.clienteAgenda,
          compact: compact,
        ),
        _MenuItem(
          icon: PhosphorIcons.broadcast(),
          label: 'Lives',
          route: AppRoutes.clienteLives,
          isSelected: currentRoute == AppRoutes.clienteLives,
          compact: compact,
        ),
      ],
